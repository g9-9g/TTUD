/*
Bài toán người đi du lịch: Công thức Quy hoạch động

- Không mất tính tổng quát giả sử chu trình bắt đầu và kết thúc tại đỉnh 0.
- Gọi TSP(i, S) là cách sử dụng ít chi phí nhất để đi qua toàn bộ các đỉnh và quay trở lại đỉnh 0, 
  nếu như hiện tại hành trình đang ở tại đỉnh i và người du lịch đã thăm tất cả các đỉnh trong tập S.
- Bước cơ sở: TSP(i, tập mọi đỉnh) = Ci,0
- Bước chuyển quy nạp:
  TSP(i, S) = min { Cij + tsp(j, S ∪ {j}) } với j ∉ S
